...
class AutomatedPipeline {
  constructor() {
    ...
    this.nasaService = nasaDataService
  ...
  getRegionCoordinates(region) {
    // Handle both string region names and region objects with coordinates
    if (typeof region === 'object' && region.lat && region.lon) {
    ...
    return { lat: 38.5111, lon: -96.8005 }
  }

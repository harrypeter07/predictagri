        ...
        (async () => {
          try {
            if (farmerData?.imageBase64) {
              ...
              if (!res.ok) return { success: true, data: imageProcessingService.getMockAnalysisResult('comprehensive'), isMock: true }
          ...
          return { success: true, data: imageProcessingService.getMockAnalysisResult('comprehensive'), isMock: true }
        })()
      ])
